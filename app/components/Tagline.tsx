...
function TagLine() {
  return (
    ...
      <div className="grid grid-cols-0 md:grid-cols-0 lg:grid-cols-0 xl:grid-cols-0 gap-8">
        <p className={`${glorifyReg.className} text-8xl text-center lg:text-center xl:text-center text-color1`}>Aheye</p>
        <p className={`${noto_S_TH.className} text-center text-8xl text-color1 -mt-5`}>อ๊ะอาย</p>
